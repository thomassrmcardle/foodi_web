    ...
    <div className="flex flex-col flex-1 items-center justify-center bg-zinc-50 font-sans dark:bg-black">
      <main className="flex flex-1 w-full max-w-3xl flex-col items-center justify-between py-32 px-16 bg-white dark:bg-black sm:items-start">
        <div>
            ...
            <p>Further user generated content, including recipes, the total number of users who have saved each recipe, and the profile picture and display name, are all publically visible through the application's corresponding website at <a href="foodi.com">{"[ADD_SITE_HERE]"}</a>. Data that the user has chosen to keep private, such as recipes which haven't been "published" are not visible to any other users other than their creator. However, this data may be accessed and modified by authorized members of the foodi team for the purposes of maintaining, debugging, securing or operating the service.</p>
            ...
            <h2>Contact</h2>
            <p>If you have any additional questions or wish to request access, modification, or deletion of your personal data, you can contact the Foodi Team at the following email address:</p>
            <p>{'[email]'}</p>
