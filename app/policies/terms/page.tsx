    ...
    return (
        ...
        <main className="flex flex-1 w-full max-w-3xl flex-col items-center justify-between py-32 px-16 bg-white dark:bg-black sm:items-start">
            <div>
                ...
                <h2>Agreement</h2>
                <p>Upon creating an account on the Cherub platform, all users must have agreed to adhere to the following policies regarding the usage of the platform and user behaviour. If these policies are not followed, appropriate action may be taken by the relevant individuals of the Cherub Team accordingly.</p>
                ...
                <p>We reccomend each person who uses the Cherub platform has their own personal account for the sake of the privacy of their information and for a greater experience while using the platform.</p>
                <p>In the event that details for an account are lost, we reccomend that users follow the following steps:</p>
                <ol>
                    <li>Go on to the Cherub platform and navigate to the "Log In" screen.</li>
                ...
                <p>Notably, we reccomend users not to share the details of their passwords with other individuals as this may provide them with access to your account. To help suser protect against such threats, the following is a list of actions the Cherub Team will never conduct.</p>
                <ol>
                    <li>Users will never be asked to share the password to an account they have created.</li>
                    <li>No member of the Cherub Team will ever request access to another user's account.</li>
                </ol>

                <h2>Publishing Media</h2>
                <p>All images published to the Cherub platform must be respectful, not containing any profanity and inappropriate content. The following is a list of prohibitted content of such media (within both text and images)...</p>
                <ol>
                ...
                <p>As per our <a href="../policies/privacy">Privacy Policy</a>, by agreeing to these terms, users allow the usage of content which they upload to Cherub by the Cherub Team for marketing purposes beyond the platform itself.</p>
                ...
                <p>Upon the deletion of an account, any subscription associated to that account will be cancelled. If this does not occur and charges continue to be made, please contatct the Cherub Team with the following email address and explain the situation and we will attempt to resolve it in due course.</p>
                <p>{"[email]"}</p>

                <h2>Moderation</h2>
                <p>All content uploaded to the platform is moderated by the Cherub Team. Any content found to be in violation of our policies may be removed. For more information, please see the Policy Enforcement section.</p>
                <p>We request that if users find any content they believe is in violation of our policies, that they report it to the Cherub Team using in inbuilt report feature. This will create a ticket for the content to be re-reviewed by our team, in which appropriate action will be taken if deemed necessary.</p>

                <h2>Policy Enforcement</h2>
                <p>If these expectations are not met, the appropriate members of the Cherub Team hold the ability to take appropriate action. However, the action taken depends on the deemed "severity" of such a violation.</p>
